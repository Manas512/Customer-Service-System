      ...
      <div id="service" class="hiw_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-md-7">
                  <h3>OUR SERVICES</h3>
                  <p>We provide quality services at your doorstep !!</p>
               </div>
               <div class="col-md-5">
               </div>
            </div>
            <div class="row">
               <div class="col-md-8 service_blog">
                  ...
                  <h3 class="blog_head">House Repairs</h3>
               </div>
               <div class="col-md-4 service_blog">
                  <img class="margin_top_30 img-responsive" src="imgs/s2.jpg" alt="#" />
                  <h3 class="blog_head">Carpenter</h3>
               </div>
               <div class="col-md-4 service_blog">
                  <img class="margin_top_30 img-responsive" src="imgs/s3.jpg" alt="#" />
                  <h3 class="blog_head">Electrician</h3>
               </div>
               <div class="col-md-4 service_blog">
                  <img class="margin_top_30 img-responsive" src="imgs/s4.jpg" alt="#" />
                  <h3 class="blog_head">Beautician</h3>
               </div>
               <div class="col-md-4 service_blog">
                  <img class="margin_top_30 img-responsive" src="imgs/s5.jpg" alt="#" />
                  <h3 class="blog_head">Painting</h3>
               </div>
               <div class="col-md-4 service_blog">
                  <img class="margin_top_30 img-responsive" src="imgs/s6.jpg" alt="#" />
                  <h3 class="blog_head">Mobile Repairing</h3>
               </div>
               <div class="col-md-4 service_blog">
                  <img class="margin_top_30 img-responsive" src="imgs/s7.jpg" alt="#" />
                  <h3 class="blog_head">Home Maid</h3>
               </div>
               <div class="col-md-4 service_blog">
                  <img class="margin_top_30 img-responsive" src="imgs/s8.jpg" alt="#" />
                  <h3 class="blog_head">Photographers</h3>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="row">
               ...
               <div class="col-lg-4 col-md-6 col-12">
                  <div class="item">
                     ...
                     <p><img src="imgs/phone_icon.png" alt="#" />+91 9021907338</p>
                     <p><strong>Corporate Office Address:</strong></p>
                     <p><img src="imgs/location.png" alt="#" />Vishwakarma Institute of Information and Technology, Pune</p>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6 col-12">
                     <div class="item">
                     ...
                     <ul>
                        ...
                        <li><img src="imgs/icon2.jpg"><a href="manassangale05@gmail.com"> Gmail</a></li>
                        <li><img src="imgs/icon3.jpg"><a href="https://www.instagram.com"> Instagrm</a></li>
                        <li><img src="imgs/icon4.jpg"><a href="https://www.facebook.com"> Facebook</a></li>
                        <li><img src="imgs/icon5.jpg"><a href="www.youtube.in"> Youtube</a></li>
                        <li><img src="imgs/icon6.jpg"><a href="https://www.linkedin.com"> LinkedIn</a></li>
                     </ul>
                  </div>
