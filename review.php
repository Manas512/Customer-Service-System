...
<p class="item-1"><?php echo $provider[0]['feedback']."<br><br>";echo "-".$provider[0]['names']; ?></p>

<p class="item-2"><?php echo $provider[1]['feedback']."<br><br>";echo "-".$provider[1]['names']; ?></p>

<p class="item-3"><?php echo $provider[2]['feedback']."<br><br>";echo "-".$provider[2]['names']; ?></p>
